...
class OrderingGroupViewModel(application: Application, private val sharedViewModel: ParamsViewModel) : AndroidViewModel(application) {
    ...
    val orderingGroup: LiveData<List<JoinOrderingGroup>> = database.orderInfoDao.getOrderingGroupList(getDeliveryAddressNum().value.toString())
