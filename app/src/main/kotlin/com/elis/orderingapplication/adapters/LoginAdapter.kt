...
class LoginAdapter : RecyclerView.Adapter<LoginAdapter.LoginHolder>() {
    ...
    private val differCallBack = object : DiffUtil.ItemCallback<OrderingLoginResponseStruct>(){
        override fun areItemsTheSame(oldItem: OrderingLoginResponseStruct, newItem: OrderingLoginResponseStruct): Boolean {
            return oldItem.sessionKey==newItem.sessionKey
        }

        override fun areContentsTheSame(oldItem: OrderingLoginResponseStruct, newItem: OrderingLoginResponseStruct): Boolean {
