...
import com.elis.orderingapplication.databinding.SendOrderCardviewBinding
import com.elis.orderingapplication.pojo2.Order
import java.time.LocalDate
import java.time.format.DateTimeFormatter
import java.util.Locale

class SendOrdersAdapter(private val clickListener: SendOrdersAdapter.MyClickListener) :
    RecyclerView.Adapter<SendOrdersAdapter.OrdersViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        return OrdersViewHolder(
            SendOrderCardviewBinding.inflate(
                LayoutInflater.from(
                    parent.context
                )
            )
    ...
    class OrdersViewHolder(private var binding: SendOrderCardviewBinding) :
